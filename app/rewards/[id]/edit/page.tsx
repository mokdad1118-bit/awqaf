  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert('حدث خطأ أثناء تحديث المكافأة')
      }
    } catch (error) {
      alert('حدث خطأ أثناء تحديث المكافأة')
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-br from-primary-dark to-primary text-white p-6">
        <h1 className="text-2xl font-bold">تعديل المكافأة</h1>
        <p className="text-white/70 mt-1">تعديل سجل المكافأة الشهرية</p>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                {saving ? 'جاري الحفظ...' : 'تحديث المكافأة'}
                <ArrowRight size={18} />
              </button>
